...
- Backend CORS config: `../data-structure-design-backend/src/main/java/com/travel/system/config/CorsConfig.java`
- Backend SQLite config: `../data-structure-design-backend/src/main/resources/application.yml`
...
```text
data-structure-design-backend/src/main/java/com/travel/system/config/CorsConfig.java
```
